...
const BestOfferViewAll = (props: IProps) => {
  ...
  const products = useSelector(bestOfferSelector);
  const loading = products?.loading;

  const [productList, setProductList] = useState(
    products?.bestOfferViewAll?.map((item: any) => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchbestOfferViewAll());
  }, [dispatch]);
            ...
            <div className='col-lg-12 pr-0 pl-0'>
              {listView ? (
                <ProductList
                  ...
                  listView={listView}
                  products={products?.bestOfferViewAll}
...
export default BestOfferViewAll;
